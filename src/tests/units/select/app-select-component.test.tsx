...
describe('AppSelectComponent', () => {
  describe('single mode (default)', () => {
    it('renders the trigger with the default placeholder', () => {
      render(<AppSelectComponent options={ITEMS} value={null} onChange={vi.fn()} />)
    ...
    it('calls onChange with the selected IOption', async () => {
      ...
      render(<AppSelectComponent options={ITEMS} value={null} onChange={onChange} />)
      const user = userEvent.setup()
      await user.click(screen.getByRole('combobox'))
  ...
  describe('disabled state', () => {
    it('disables the trigger when disabled is true', () => {
      render(<AppSelectComponent options={ITEMS} value={null} onChange={vi.fn()} disabled />)
  ...
  describe('empty state', () => {
    it('shows the default empty message when options list is empty', async () => {
      render(<AppSelectComponent options={[]} value={null} onChange={vi.fn()} />)
      const user = userEvent.setup()
      await user.click(screen.getByRole('combobox'))
